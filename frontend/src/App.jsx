...
import ChatBot from "./pages/ChatBot"; // Assuming you have a ChatBot page
        ...
        <Web3Provider>
          <MarketplaceProvider>
            ...
            <Routes>
              ...
              <Route
                path="/list-asset-for-sale"
                element={<ListAssetForSale />}
              />
              <Route
                path="/remove-asset-from-sale"
                element={<RemoveAssetFromSale />}
              />
